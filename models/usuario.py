class usuario:
    ...
    def __init__(self, id, usuario_id, descricao, valor_alvo, valor_atual, prazo, data_limite):
    ...
    def valor_alvo_maior(self):
        if self.valor_atual >= self.valor_alvo:
            return f"Parabéns! Você atingiu seu objetivo de {self.descricao}."
