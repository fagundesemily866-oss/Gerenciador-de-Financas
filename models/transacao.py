class Transacao:
    ...
    def __init__(self, id, usuario_id, categoria_id, terceiro_id, descricao,
                 valor, tipo, status, data_vencimento, data_pagamento=None,
    ...
    @categoria_id.setter
    def categoria_id(self, novo_categoria_id):
        self._categoria_id = novo_categoria_id
    ...
    def esta_paga(self):
        return self._status == "PAGO" or self._data_pagamento is not None

    def esta_atrasada(self):
        if self.esta_paga():
            return False
        return self._data_vencimento is not None